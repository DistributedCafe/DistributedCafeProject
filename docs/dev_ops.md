...
The API documentation is available here: [Documentation](./resources/documentation.md).
...
The code documentation is available here: [Documentation](./resources/documentation.md).
